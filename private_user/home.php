...
.pull-right {
    ...
    .default-color {
      background-color: #030748!important;
    }

    .nav-pills .nav-link.active, .nav-pills .show>.nav-link {
    color: #fff;
    background-color:#030748;
  }
  
.element.style {
    border-top: 4px solid #121515;
    border-radius: 4px;
    box-shadow: 0px 1px 1px 0px #6c757d;
}
.element.style {
...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color fixed-top">
    <a class="navbar-brand" href="#"><img src="js/img/icons9.png"   width="70px" height="33px"> <font color="#ffffff">UPHSL-IC REGISTRAR INFORMATION MANAGEMENT SYSTEM</font></a>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-4" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">
           <font color="white">Welcome! </font> <?php echo ucwords(htmlentities($id)); ?> <i class="fas fa-user-circle"></i> Login </a>
...
<tbody>
    ...
    <tr>
      ...
      <td><?php echo $download; ?></td>
        ...
        <td style=""><a href='downloads.php?file_id=<?php echo $id; ?>'><img src="img/icons8.png" width="30px" height="30px" title="Download File"></a> </td>
    </tr>
<?php } ?>
</tbody>
   </table>
 ...
 <div class="col-md-3" style="border-top: 4px solid #030748;border-radius: 4px;  box-shadow: 0px 2px 2px 0px  #030748;"><br>
...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  ...
  <img src="img/prof.png" class="rounded" alt="..."><hr>
    <div class="">
     
     <div class=""><p><b style="font-size: 1.1em">Full Name:</b> Staff</p></div>
     <div class=""><p><b style="font-size: 1.1em">Position:</b> Registrar staff</p></div>

  </div>
  <hr>
  </div>
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
   <h6 style="font-size: 1.1em">Registrar Information Management System (RIMS)</h6><Hr>
  ...
  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"><h6 style="font-size: 1.1em">Contact Number</h6><Hr><br><div class=""><p><b style="font-size: 1.1em">Cellphone #:</b>09XXXXXXXXX</p></div><p><b style="font-size: 1.1em">Address :</b>Philippines</p>
</div><hr><br>
<!--   <div class="card">
  <ul class="list-group list-group-flush">
   ...
   <!-- Card -->
<div class="card" style="border-top: 4px solid #030748;border-radius: 4px;">
