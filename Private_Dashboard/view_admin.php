...
<body class="grey lighten-3">
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <img src="img/uphsl.png" width="140px" height="180px;" class="img-fluid" alt="">
      </a>
...
<!--end modaladmin-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold"><i class="fas fa-user-plus"></i> Add Registrar staff</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="">
 ...
 <p>Office of the University Regisrar&copy; <?php echo date('Y');?></p>
    </div>
    <!--/.Copyright-->
